...
import com.amap.location.demo.adapter.SearchAdapter;
import com.amap.location.demo.bean.SearchAddressInfo;
import com.amap.location.demo.utils.ToastUtil;
import java.util.ArrayList;
import java.util.List;

public class SearchAddressActivity extends CheckPermissionsActivity implements View.OnClickListener, PoiSearch.OnPoiSearchListener, AdapterView.OnItemClickListener {
